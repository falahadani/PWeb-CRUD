...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark text-uppercase" style="background-color: Black;">
        <div class="container">
            <a class="navbar-brand text-white fw-bold" href="index.php">Sistem Data Mahasiswa</a>
    ...
    <div class="container">
        <div class="glass-container">
            ...
            <div class="row my-2">
                <div class="col-md">
                    <h3 class="text-center fw-bold text-uppercase text-dark data_siswa">DATA MAHASISWA</h3>
                    <hr>
                </div>
            </div>
            ...
            <div class="row my-2">
                <div class="col-md">
                    ...
                    <a href="export.php" class="btn btn-success ms-1" target="_blank" data-aos="fade-left" data-aos-duration="800"
                        data-aos-delay="1200"><i class="bi bi-file-earmark-spreadsheet-fill"></i> Export ke Excel</a>
                </div>
            </div>
